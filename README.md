...
```sh
helm install python-app-11 ./charts/python-app-11 \
  --set image.repository=jaimehenao8126/python-app-11 \
  --set image.tag=<tag>
```

- Ingress por defecto: `python-app-11.test.com`
...
- [charts/python-app-1/](./charts/python-app-11/): Helm chart y valores
